...
describe("ClipSchema", () => {
  describe("#start timestamp", () => {
    it.each(["1:23:45", "23:45", "2:34", "1:02", "59:59", "1:00:00", "0:00", "0:58", "9:59:00"])(
      'accepts valid timestamp "%s"',
      (start) => {
    ...
    it.each(["", "123", "1:60", "1:2:60", "ab:cd", "1:2:3:4", ":30", "1:"])(
...
describe("ScoutingSchema", () => {
  const base = {
    ...
    clips: [{ start: "1:23", description: "Good block.", type: "good-play" as const }],
  };

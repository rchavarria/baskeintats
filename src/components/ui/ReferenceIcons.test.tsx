...
describe("ReferenceIcons", () => {
  ...
  it("shows an article reference with 📰 emoji", () => {
    render(
      <ReferenceIcons
        references={[
          { type: "article", label: "News article", url: "https://example.com/article" },
        ]}
      />,
    );
  ...
  it("shows a document reference with 💼 emoji", () => {
    render(
      <ReferenceIcons
        references={[
          { type: "document", label: "Official document", url: "https://example.com/doc" },
        ]}
      />,
    );
  ...
  it("shows a photo reference with 📸 emoji", () => {
    render(
      <ReferenceIcons
        references={[{ type: "photo", label: "Team photo", url: "https://example.com/photo" }]}
      />,
    );
  ...
  it("shows a stats reference with 📈 emoji", () => {
    render(
      <ReferenceIcons
        references={[{ type: "stats", label: "Game stats", url: "https://example.com/stats" }]}
      />,
    );
  ...
  it("shows a social-media reference with 📱 emoji", () => {
    render(
      <ReferenceIcons
        references={[
          { type: "social-media", label: "Instagram post", url: "https://example.com/social" },
        ]}
      />,
    );
  ...
  it("shows a web reference with 💻 emoji", () => {
    render(
      <ReferenceIcons
        references={[{ type: "web", label: "Official website", url: "https://example.com/web" }]}
      />,
    );
  ...
  it("shows a video reference with 🎥 emoji", () => {
    render(
      <ReferenceIcons
        references={[{ type: "video", label: "Game highlights", url: "https://example.com/video" }]}
      />,
    );
  ...
  it("uses the reference label as the title attribute of the span", () => {
    render(
      <ReferenceIcons
        references={[{ type: "web", label: "My custom label", url: "https://example.com/web" }]}
      />,
    );

...
function makeBasicGame(
  ...
  return {
    ...
    home: {
      club: { id: "team-a", name: "Equipo A", logo: "default.png" },
      category: "U15M" as const,
      opponent: false,
      scores: [20, 20],
    },
    away: {
      club: { id: "team-b", name: opponent, logo: "default.png" },
      category: "U15M" as const,
      opponent: true,
      scores: [15, 15],
    },
    playerStats: {
      ...
      fieldGoals,
      threePointers,
      freeThrows: { made: ftMade, attempted: ftAttempted },
      faults: 2,
      plusMinus: 5,
      efficiency: 10,
    },
...
function makeAdvancedGame(
  id: string,
  date: string,
  opponent: string,
  fg: { made: number; attempted: number },
  tp: { made: number; attempted: number },
  ...
  return {
    ...
    away: {
      club: { id: "team-c", name: opponent, logo: "default.png" },
      category: "U15M" as const,
      opponent: true,
      scores: [18, 18],
    },
...
describe("StatsCard", () => {
  ...
  it("shows all lines of the 'description'", () => {
    const stats = {
      ...
      description: ["Line #1 of description", "Line #2 of description", "Line #3 of description"],
      references: [],
    };

...
import { announcement_2025_07_27_dme_team_camp_eoss_summary } from "../../data/games/2025-07-27-dme-team-camp-eoss-summary.ts";
...
const fakeAnnouncement: Announcement = {
  ...
  category: "U14M",
  description: ["Gran torneo durante las fiestas de Reyes."],
  references: [],
};
...
describe("AnnouncementCard", () => {
  ...
  it("truncates description to 2 lines with ellipsis when more than 2", () => {
    const longAnnouncement: Announcement = {
      ...fakeAnnouncement,
      description: ["Primera línea visible.", "Segunda línea visible.", "Tercera línea oculta."],
    };

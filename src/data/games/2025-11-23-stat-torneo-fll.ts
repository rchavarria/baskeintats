...
export const stat_2025_11_23_torneo_fll: Stats = StatsSchema.parse({
  ...
  games: [game_2025_11_21_real_madrid, game_2025_11_22_joventut, game_2025_11_23_seleccion_madrid],
  ...
  references: [
    {
      type: "article",
      label:
        "Toda la información sobre el XV Torneo FLL (Calendario, dosier de prensa, equipos participantes, rosters, resultados...)",
